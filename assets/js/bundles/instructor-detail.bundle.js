/* instructor-detail JS Bundle - Generated */
				...
				if (entry.isIntersecting) {
					...
					$({ countNum: 0 }).animate(
						...
						},
						{
							...
							easing: "linear",
							step: function () {
								$this.text(toArabicNumerals(Math.floor(this.countNum)));
							},
							complete: function () {
								$this.text(toArabicNumerals(Math.floor(this.countNum)));
							}
